...
import { BorderElement, ControlButton, MainContainer } from "~/app-styles/mixins-styles";
...
export const MachineControlsInputContainer = styled.div<{ $content: string }>`
    ${props => BorderElement({ _textColour: props.theme.TEXT, _bgcColour: props.theme.BODY, _content: props.$content })
};
    padding: 10px;
    width: 300px;
`;
