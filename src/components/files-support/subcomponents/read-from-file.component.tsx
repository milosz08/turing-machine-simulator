...
import {
    FilesSupportAsideTextValue, FilesSupportInput, FilesSupportLabel, FilesSupportWrapper
        ...
        if (window.File && window.FileReader && window.FileList && window.Blob) {
            ...
            if (file.type.match(textFile)) {
                reader.onload = (e: ProgressEvent<FileReader>) => {
                    dispatcher(MachineAction.loadExampleProgramAction({ sourceCode: e.target.result as string }));
