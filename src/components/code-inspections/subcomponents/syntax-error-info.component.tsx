...
const SyntaxNonErrorsComponent = React.lazy(() => import("../subcomponents/syntax-non-errors.component"));
...
const SyntaxErrorInfoComponent: React.FC = (): JSX.Element => {
    ...
    const { machineTuples }: IMachineStoreReduxState = useSelector((state: RootState) => state.machine);
