 ...
 *   Created at: 2023-07-31, 23:43:15
 *   Last updated at: 2023-08-30, 18:31:37
...
export const switchMachineStateAction = createAction<
  ActionType.SwitchMachineStateActionType,
  Actions
...
export const setInitialTapeInputAction = createAction<
  ...
  Actions
>(Actions.SET_INITIAL_TAPE_INPUT);

export const setChangeInputStateAction = createAction<
  ActionType.SetChangeInputStateActionType,
  Actions
>(Actions.SET_CHANGE_INPUT_STATE);

export const machineStartStopTogglingAction = createAction<void, Actions>(
...
export const loadExampleProgramAction = createAction<
  ActionType.LoadExampleProgramActionType,
  Actions
